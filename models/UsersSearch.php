...
class UsersSearch extends Users
{
    ...
    {
        return [
            [['id', 'confirmation_sent_at', 'confirmed_at', 'recovery_sent_at', 'blocked_at', 'registered_from', 'logged_in_from', 'logged_in_at', 'created_at', 'updated_at', 'role'], 'integer'],
            [['name','username', 'email', 'password_hash', 'auth_key', 'confirmation_token', 'unconfirmed_email', 'recovery_token', 'registration_ip', 'status', 'password_reset_token', 'department_id','depname'], 'safe'],
        ];
    }
